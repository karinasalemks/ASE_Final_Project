...
class DublinBikesHeatMap extends StatefulWidget {
  @override
  State<DublinBikesHeatMap> createState() => DublinBikesHeatMapState();
}

class DublinBikesHeatMapState extends State<DublinBikesHeatMap> {
